import Drive.*
class Train (var _number : Int, var _exit_time: Double, var _come_time : Double , emptime : Double, emptravel : String, empdestination : String, emplength : Double)
    : Drive(empdestination, emptravel, emptime, emplength) {
    fun Right_train(emplength: Double, emptime: Double){
        ...
        when{
            emptime > 9.00 && emptime <= 15.00 -> {
                println("вам доступно два поезда 1 или 52")
            ...
            emptime > 15.00 && emptime <= 21.00 -> {
                println("вам доступен один поезд 140")
                _number = numbers[1]
            }
            emptime > 21.00 && emptime <= 3.00 -> {
                println("вам доступно три поезда 140, 100, 52")
            ...
            emptime > 3 && emptime <= 9.00 -> {
                println("вам доступен один поезд 100")
                _number = numbers[3]
            }
        }
        }
